...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($image))
        {
            ...
            $postImage = \Intervention\Image\Facades\Image::make($image)->resize(1600, 1066)->stream();
        ...
        \Brian2694\Toastr\Facades\Toastr::success('Post Successfully Created', 'Success');
    ...
    public function update(Request $request, Post $post)
    {
        ...
        \Brian2694\Toastr\Facades\Toastr::success('Post Successfully Updated', 'Success');
        return redirect()->route('admin.post.index');
